 ...
 * Use the [ViewAllComplaintsFragment.newInstance] factory method to
...
class ViewAllComplaintsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ViewAllComplaintsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ViewAllComplaintsFragment().apply {
